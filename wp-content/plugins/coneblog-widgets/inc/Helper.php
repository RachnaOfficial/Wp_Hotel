...
class Helper
{
    ...
    public static function coneblog_posted_on() {
		...
		echo '<span class="posted-on"><i class="icon-calendar"></i> ' . $posted_on. '</span>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    ...
    public static function coneblog_entry_comments() {
		...
		if($comment_count == 0) {
			echo '<span class="post-meta post-comments"><i class="icon-chat"></i> <a href="'.esc_url(get_comments_link( get_the_ID()) ).'">'. esc_html__(" 0", "flashwp-lite") .'</a></span>';
		} elseif($comment_count = 1){
			echo '<span class="post-meta post-comments"><i class="icon-chat"></i>'.esc_html($comment_count).' <a href="'.esc_url(get_comments_link( get_the_ID() )).'">'. esc_html__(" Comment", "flashwp-lite") .'</a></span>';
		} else {
			echo '<span class="post-meta post-comments"><i class="icon-chat"></i>'.esc_html($comment_count).' <a href="'.esc_url(get_comments_link( get_the_ID() )).'">'. esc_html__(" Comments", "flashwp-lite") .'</a></span>';
		}
