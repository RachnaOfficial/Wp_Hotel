...
class coneblog_Slider_Posts extends Widget_Base {
	...
	protected function render() {
		...
		?>
            <div class="coneblog-posts-slider-container layout-<?php echo $layout ?>">
                <div class="coneblog-posts-slider layout-<?php echo $layout ?>">
			...
			<script>
				jQuery(document).ready(function($){
					$(".coneblog-slider").owlCarousel({
                        items: 1,
                        margin: <?php echo( $settings['carousel_margin'] ) ?>,
                        loop: <?php echo ($settings['carousel_loop'] == 'yes' ? 'true' : 'false') ?>,
                        nav: <?php echo ($settings['carousel_arrownav'] == 'yes' ? 'true' : 'false') ?>,
                        dots: <?php echo ($settings['carousel_dotnav'] == 'yes' ? 'true' : 'false') ?>,
                        rtl: <?php echo ($settings['carousel_direction'] == '2' ? 'true' : 'false') ?>,
                        navText: ['<i class="fa fa-chevron-left"></i>', '<i class="fa fa-chevron-right"></i>'],
                        lazyLoad: <?php echo ($settings['carousel_lazyload'] == 'yes' ? 'true' : 'false') ?>,
                        autoplay: <?php echo ($settings['carousel_autoplay'] == 'yes' ? 'true' : 'false') ?>,
                        autoplayTimeout: <?php echo( $settings['carousel_autoplay_speed'] ) ?>,
